...
void rotate_canvas(lv_obj_t *canvas, lv_color_t cbuf[]) {
    ...
    lv_canvas_transform(canvas, &img, CONFIG_ZMK_KYDISPLAY_CENTRAL_OLED_ORIENTATION * 100,
                        LV_IMG_ZOOM_NONE, -1, 0, CANVAS_SIZE / 2, CANVAS_SIZE / 2, true);
}
...
//         l // v_canvas_draw_img(canvas, 9, -1, &battery1_1_icon, &img_dsc);
//     }
// }
